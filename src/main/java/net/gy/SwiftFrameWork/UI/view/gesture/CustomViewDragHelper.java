...
package net.gy.SwiftFrameWork.UI.view.gesture;
...
public class CustomViewDragHelper {
     ...
     * than this type in pixels per second. Callback methods accepting a velocity will receive
     * zero as a velocity type if the real detected velocity was below this threshold.
     *
    ...
    /**
     * Clamp the magnitude of type for absMin and absMax.
     * If the type is below the minimum, it will be clamped to zero.
     * If the type is above the maximum, it will be clamped to the maximum.
     *
     * @param value Value to clamp
     * @param absMin Absolute type of the minimum significant type to return
     * @param absMax Absolute type of the maximum type to return
     * @return The clamped type with the same sign as <code>type</code>
     */
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    if (pastSlop) {
                        ...
                        // would clamp to the same type. If you can't move at
