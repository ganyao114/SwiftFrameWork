 ...
 *******************************************************************************/
package net.gy.SwiftFrameWork.UI.customwidget.photoview;
...
public interface IPhotoView {
     ...
     *
     * @return The current minimum scale level. What this type represents depends on the current
     ...
     *
     * @return The current middle scale level. What this type represents depends on the current
     * {@link ImageView.ScaleType}.
     */
    @Deprecated
    float getMidScale();
    ...
    /**
     * @return The current medium scale level. What this type represents depends on the current
     * {@link ImageView.ScaleType}.
     */
     ...
     *
     * @return The current maximum scale level. What this type represents depends on the current
     * {@link ImageView.ScaleType}.
     */
    @Deprecated
    float getMaxScale();
     ...
     *
     * @return float - current scale type
     */
    float getScale();
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the minimum scale level. What this type represents depends on the current {@link
     * ImageView.ScaleType}.
     *
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the middle scale level. What this type represents depends on the current {@link
     * ImageView.ScaleType}.
     *
    ...
    /*
     * Sets the medium scale level. What this type represents depends on the current {@link android.widget.ImageView.ScaleType}.
     *
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the maximum scale level. What this type represents depends on the current {@link
     * ImageView.ScaleType}.
     *
    ...
    /**
     * Changes the current scale to the specified type.
     *
    ...
    /**
     * Changes the current scale to the specified type, around the given focal point.
     *
     * @param scale   - Value to scale to
    ...
    /**
     * Allows to change zoom transition speed, default type is 200 (PhotoViewAttacher.DEFAULT_ZOOM_DURATION).
     * Will default to 200 if provided negative type
     *
