package net.gy.SwiftFrameWork.UI.customwidget.floatactionbt;
...
@SuppressLint("NewApi") public class FloatingActionsMenu extends ViewGroup {
  ...
  @SuppressLint("NewApi") private AnimatorSet mExpandAnimation = new AnimatorSet().setDuration(ANIMATION_DURATION);
